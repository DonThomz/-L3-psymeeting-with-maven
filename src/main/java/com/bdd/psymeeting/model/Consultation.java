...
public class Consultation extends RecursiveTreeObject<Consultation> {
    ...
    public Consultation(int consultationID) {
        ...
        try (Connection connection = App.database.getConnection()) {
            ...
            // assign attributes
            this.date = App.Timestamp2Calendar(resultSet.getTimestamp(1));
    ...
    public static Map<Timestamp, Boolean> getTimeSlots(LocalDate dateField) {
        ...
        try (Connection connection = App.database.getConnection()) {
            ...
            String[] dates = App.getDatesOfDay(dateField);
    ...
    private static Map<Timestamp, Boolean> initTimeSlotsByDateSelected(LocalDate date) {
        ...
        timeSlots.put(Timestamp.valueOf(selectDate + " 08:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 08:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 09:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 09:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 10:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 10:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 11:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 11:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 14:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 14:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 15:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 15:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 16:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 16:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 17:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 17:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 18:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 18:30:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 19:00:00"), false);
        timeSlots.put(Timestamp.valueOf(selectDate + " 19:30:00"), false);
    ...
    public static boolean insertIntoConsultationTable(Timestamp consultationDate, int consultationID, boolean anxietyValue, boolean coupleValue) {
        try (Connection connection = App.database.getConnection()) {
            ...
            preparedStmt.setBoolean(3, anxietyValue);

            preparedStmt.setBoolean(4, coupleValue);
